...
public class DummyData {
    ...
    //    (int UID, String bname, String address, double lat, double lng, String state, float rate)
        util.addBike(
                ...
                "Stuart Building 10 West 31st Street Chicago",
                41.838310,
                -87.627371,
                "New",
                (float)5.00
        ...
        util.addBike(
                ...
                "Red Mangoose",
                "3038 South Princeton Avenue Chicago",
                41.838344, -87.634274,
                "New",
                (float)5.00
        );
        ...
        util.addBike(
                ...
                "IIT Krishna House S michigan avenue Chicago",
                41.837287,
                -87.623352,
                "Good",
                (float)5.00
        ...
        util.addBike(
                util.getUID("cshe@gmail.com"),
                "White Kulana Womens",
                "dunbar vocational high school s king drive Chicago",
                41.840593, -87.618068,
                "Like New",
                (float)15.00
        );
